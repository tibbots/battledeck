...
namespace Battledeck.Tests
{
    ...
    public class XamlLoadsTests
    {
                ...
                foreach (var component in ComponentPaths())
                {
                    ...
                    try
                    {
                        Application.LoadComponent(
                            new Uri($"/Battledeck;component/{component}", UriKind.Relative));
        ...
        private static IEnumerable<string> ComponentPaths()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Battledeck.g.resources")
                               ?? throw new InvalidOperationException(
                                   "Battledeck.g.resources is missing - the app assembly carries no compiled XAML at all.");
            ...
            Assert.True(found.Count > 0, "No .baml entries in Battledeck.g.resources.");
            return found;
        }
