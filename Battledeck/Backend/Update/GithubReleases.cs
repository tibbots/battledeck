...
namespace Battledeck.Backend.Update
{
    /// <summary>
    ///     One published release of <c>tibbots/battledeck</c>, reduced to the three things an
    ...
    public sealed record GithubRelease(string Version, string PageUrl, IReadOnlyList<GithubAsset> Assets)
    {
        ...
        ///         <c>Battledeck_{version}_win-x64.zip</c> from the version - the name <c>dev</c>
    ...
    ///     <para>
    ///         <b>Anonymous, and that is the whole point.</b> <c>tibbots/battledeck</c> is a
    ...
    {
        public const string Repository = "tibbots/battledeck";
        ...
        /// </summary>
        public const string ReleasesPage = "https://github.com/tibbots/battledeck/releases/latest";

        private const string LatestApi = "https://api.github.com/repos/tibbots/battledeck/releases/latest";
        ...
        private static HttpClient Create()
        {
            ...
            http.DefaultRequestHeaders.Add("User-Agent", $"Battledeck/{AppVersion.Current}");
        ...
        public static async Task<GithubRelease?> Latest(CancellationToken cancel = default)
        {
            try
            {
                ...
                // tibbots/battledeck, which carried the tags 1.0.0, 2.0.0 and 2.1.0 and
